...
var geometry = 
    ...
    ee.Geometry.Polygon(
        [[[-87.21086107527896, 38.07194381212634],
          [-87.21086107527896, 31.88462399992343],
          [-77.89445482527896, 31.88462399992343],
          [-77.89445482527896, 38.07194381212634]]], null, false);
...
var ls = getImageLib.getProcessedLandsatScenes(studyArea,startYear,endYear,startJulian,endJulian,
...
ls = ls.map(getImageLib.addJulianDayBand)
//Separate into scenes and composites for subsequent analysis
var processedScenes = ls;
...
ee.List.sequence(5,100,20).getInfo().map(function(pctl){
  var out = getImageLib.customQualityMosaic(processedScenes, 'NDVI', pctl);
  Map.addLayer(out, {min:0.005,max:0.1,bands:'red,green,blue'}, 'pctl'+pctl.toString())
